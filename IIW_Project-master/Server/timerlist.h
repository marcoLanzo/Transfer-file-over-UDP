//
// Tale header contiene al suo interno operazioni per la creazione e gestione di una lista collegata
//
...
#ifndef IIW2_TIMERLIST_H
#define IIW2_TIMERLIST_H

#endif //IIW2_TIMERLIST_H
